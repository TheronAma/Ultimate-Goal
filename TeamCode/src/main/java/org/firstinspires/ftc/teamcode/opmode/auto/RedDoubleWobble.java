...
@Autonomous
public class RedDoubleWobble extends OpModeBase {

    private DriveConstraints secondBaseConstraints = new DriveConstraints(50,40,0, Math.toRadians(180),Math.toRadians(180),0);
    ...
    private MecanumConstraints lessSlowConstraints = new MecanumConstraints(secondBaseConstraints, DriveConstants.TRACK_WIDTH);

    public static double TARGET_RPM = 3950;
    public static double TARGET_ANGLE = 20;
    public static double ANGLE_OFFSET = 5;
    ...
    public static Pose2d NO_RING_WOBBLE_POSE = new Pose2d(0,-55, -Math.PI/3);
    public static Pose2d ONE_RING_WOBBLE_POSE = new Pose2d(33,-24,-Math.PI/3);
    public static Pose2d FOUR_RING_WOBBLE_POSE = new Pose2d(56,-51.5,-Math.PI/3);

    public static Pose2d NO_RING_TURN_POSE = new Pose2d(18,-30, Math.PI);
    public static Pose2d ONE_RING_TURN_POSE = new Pose2d(23,-18,Math.PI);
    public static Pose2d FOUR_RING_TURN_POSE = new Pose2d(52,-35,Math.PI);

    public static Pose2d FOUR_RING_HOME_WOBBLE_POSE = new Pose2d(-36,-40.5,-Math.PI);
    public static Pose2d ONE_RING_HOME_WOBBLE_POSE = new Pose2d(-35,-35,-Math.PI);
    public static Pose2d NO_RING_HOME_WOBBLE_POSE = new Pose2d(-37,-43,-Math.PI);

    public static Pose2d FOUR_RING_WOBBLE_TWO_POSE = new Pose2d(49,-53,-Math.PI/6);
    public static Pose2d ONE_RING_WOBBLE_TWO_POSE = new Pose2d(26,-30,0.0);
    public static Pose2d NO_RING_WOBBLE_TWO_POSE = new Pose2d(-5,-57.5,0.0);

    public static Pose2d SECOND_TURN_POSE = new Pose2d(-37,-26, 0.0);

    public static Pose2d PICK_UP_POSE = new Pose2d(-24.5,-22,-Math.PI/2);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory wobbleTraj4 = drive.trajectoryBuilder(SHOOT_POSE, SHOOT_POSE.getHeading())
                .splineTo(new Vector2d(FOUR_RING_WOBBLE_POSE.getX(),FOUR_RING_WOBBLE_POSE.getY()), -Math.PI/3.5)
                .addTemporalMarker(0.1,()->shooter.setPower(0))
                .addTemporalMarker(1.7,()->wobble.extend())
                .addTemporalMarker(2.1,()->wobble.open())
                .build();

        Trajectory wobbleTraj1 = drive.trajectoryBuilder(SHOOT_POSE,SHOOT_POSE.getHeading())
                .splineToLinearHeading(ONE_RING_WOBBLE_POSE, -Math.PI/2)
                .addTemporalMarker(0.1,()->shooter.setPower(0))
                .addTemporalMarker(1.3,()->wobble.extend())
                .build();

        Trajectory wobbleTraj0 = drive.trajectoryBuilder(SHOOT_POSE,SHOOT_POSE.getHeading())
                .splineToLinearHeading(NO_RING_WOBBLE_POSE, -Math.PI/2)
                .addTemporalMarker(0.1,()->shooter.setPower(0))
                .addTemporalMarker(1.2,()->wobble.extend())
                .build();

        Trajectory pickUpTraj = drive.trajectoryBuilder(SHOOT_POSE, SHOOT_POSE.getHeading())
        ...
        Trajectory turnTraj1 = drive.trajectoryBuilder(ONE_RING_WOBBLE_POSE, true)
                .splineToLinearHeading(ONE_RING_TURN_POSE, Math.PI)
                .addTemporalMarker(0.1,()->wobble.retract())
                .addTemporalMarker(0.2,()->wobble.open())
                .build();

        Trajectory turnTraj4 = drive.trajectoryBuilder(FOUR_RING_WOBBLE_POSE, true)
                .splineTo(new Vector2d(FOUR_RING_TURN_POSE.getX(), FOUR_RING_TURN_POSE.getY()), FOUR_RING_TURN_POSE.getHeading() + Math.PI)
                .addTemporalMarker(0.1,()->wobble.retract())
                .addTemporalMarker(0.2,()->wobble.open())
                .build();

        Trajectory secondWobblePick0 = new TrajectoryBuilder(NO_RING_TURN_POSE,slowConstraints)
                .splineTo(new Vector2d(NO_RING_HOME_WOBBLE_POSE.getX(),NO_RING_HOME_WOBBLE_POSE.getY()),-Math.PI)
                .addTemporalMarker(1,()->wobble.extend())
                .build();

        Trajectory secondWobblePick1 = new TrajectoryBuilder(ONE_RING_TURN_POSE,slowConstraints)
                .splineTo(new Vector2d(ONE_RING_HOME_WOBBLE_POSE.getX(), ONE_RING_HOME_WOBBLE_POSE.getY()),-Math.PI)
                .addTemporalMarker(1.5 ,()->wobble.extend())
                .build();

        Trajectory secondWobblePick4 = new TrajectoryBuilder(FOUR_RING_TURN_POSE, lessSlowConstraints)
                .splineTo(new Vector2d(FOUR_RING_HOME_WOBBLE_POSE.getX(),FOUR_RING_HOME_WOBBLE_POSE.getY()),FOUR_RING_HOME_WOBBLE_POSE.getHeading())
                .addTemporalMarker(1.7,()->wobble.extend())
                .build();
        ...
        Trajectory homeTraj0 = drive.trajectoryBuilder(NO_RING_WOBBLE_TWO_POSE, true)
                .splineToConstantHeading(new Vector2d(12,-20), 0.0)
