...
public class RedTeleOp extends LinearOpMode {
    ...
    private double shooterRpm = 4250;
    private double shooterAngle = 22;

    private int shotNum = 0;

    public static double firstShotAngle = Math.toRadians(-7);
    public static double secondShotAngle = Math.toRadians(0.5);
    public static double thirdShotAngle = Math.toRadians(6);

    public static Vector2d POWER_POSE = new Vector2d(-40,  33);

    private Vector2d POWER_SHOT_1_POS = new Vector2d(-6,31);
    private Vector2d POWER_SHOT_2_POS = new Vector2d(-6,40.5);
    private Vector2d POWER_SHOT_3_POS = new Vector2d(-6,59.5);
